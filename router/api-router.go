...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/dodopayments/webhook", controller.DodoPaymentsWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/tiers", controller.GetAffTiers)
				selfRoute.GET("/topup/info", controller.GetTopUpInfo)
				selfRoute.GET("/topup/exchange-rate", controller.GetExchangeRate)
				selfRoute.GET("/topup/self", controller.GetUserTopUps)
				selfRoute.GET("/topup/detail/:id", controller.GetUserTopUpDetail)
				...
				selfRoute.POST("/dodopayments/pay", middleware.CriticalRateLimit(), controller.RequestDodoPaymentsPay)
		...
		logRoute.GET("/self/stat-by-day", middleware.UserAuth(), controller.GetLogsSelfStatByDay)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/tags", controller.GetAllModelTags)
