...
import (
	...
	"github.com/QuantumNous/aggre-api/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "aggre-api:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "aggre-api:channel_affinity_usage_cache_stats:v1"
)
