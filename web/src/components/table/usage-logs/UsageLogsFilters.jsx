...
/**
 * UsageLogsFilters — unified filter bar for the Usage Logs card page.
 *
 * Layout (matching the HTML mockup):
 *   ┌─────────────────────────────────────────────────────────────────┐
 *   │ [🔍 keyword search (grow)] [📅 date range] [type dropdown] [↻] │
 *   └─────────────────────────────────────────────────────────────────┘
 */
const UsageLogsFilters = ({
  searchQuery,
  setSearchQuery,
  dateRange,
  setDateRange,
      ...
      <div className='cp-filter-row'>
        ...
        >
          <Select
            ...
            onChange={(v) => setSelectedLogType(v)}
            size='default'
            style={{
              minWidth: 120,
              border: 'none',
          ...
          >
            ...
            <Select.Option value='6'>{t('退款')}</Select.Option>
          </Select>
        </div>
...
export default UsageLogsFilters;
