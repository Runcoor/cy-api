...
本文档提供使用宝塔面板 Docker 功能部署 Aggre API 的图文教程。

> 📖 官方文档：[宝塔面板部署](https://docs.aggreapi.pro/zh/docs/installation/deployment-methods/bt-docker-installation)
...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/aggre-api`
...
services:
  aggre-api:
    image: calciumion/aggre-api:latest
    container_name: aggre-api
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
```bash
# 拉取最新镜像
docker pull calciumion/aggre-api:latest
...
- [官方文档](https://docs.aggreapi.pro/zh/docs/installation)
- [环境变量配置](https://docs.aggreapi.pro/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://docs.aggreapi.pro/zh/docs/support/faq)
- [GitHub 仓库](https://github.com/QuantumNous/aggre-api)
