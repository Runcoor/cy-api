...
import (
	...
	"github.com/runcoor/aggre-api/pkg/cachex"
...
const (
	subscriptionPlanCacheNamespace     = "aggre-api:subscription_plan:v1"
	subscriptionPlanInfoCacheNamespace = "aggre-api:subscription_plan_info:v1"
)
...
type SubscriptionPlan struct {
	...
	DodoProductId  string `json:"dodo_product_id" gorm:"type:varchar(128);default:''"`
...
func CompleteSubscriptionOrder(tradeNo string, providerPayload string) error {
	...
	if logUserId > 0 {
		...
		MaybeGrantInviteRewardOnFirstTopUp(logUserId)
	}
	return nil
}
