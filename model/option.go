...
func InitOptionMap() {
	...
	common.OptionMap["AffTierEnabled"] = strconv.FormatBool(common.AffTierEnabled)
	common.OptionMap["AffTiers"] = common.AffTiers
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AffTierEnabled":
		common.AffTierEnabled, _ = strconv.ParseBool(value)
	case "AffTiers":
		// Lightweight validation: ensure it parses as JSON array of tiers.
		if _, perr := parseAffTiers(value); perr == nil {
			common.AffTiers = value
		}
