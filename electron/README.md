# Aggre API Electron Desktop App

This directory contains the Electron wrapper for Aggre API, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., aggre-api-macos)
cp ../aggre-api-macos ../aggre-api
```
...
- Store database in `../data/aggre-api.db`
...
### Database Location
- **Development**: `../data/aggre-api.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/Aggre API/data/`
  - Windows: `%APPDATA%/Aggre API/data/`
  - Linux: `~/.config/Aggre API/data/`
